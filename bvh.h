...
public:
    ...
    // Considers a subset of the object list and orders them into bvh tree with other hittables at leaves
    bvh_node(std::vector<shared_ptr<hittable>> &objects, size_t start, size_t end, double time0, double time1) {
        ...
        // Number of indexes in the objects vector that we are considering
        ...
        if (object_span == 1) {
            ...
            // Sort the objects in the index range
